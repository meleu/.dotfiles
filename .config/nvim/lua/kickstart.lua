...
require('lazy').setup({
  ...
  -- Go Replace - gr{text object}
  'inkarkat/vim-ReplaceWithRegister',

  -- Go Sort - gs{text object}
  'christoomey/vim-sort-motion',

  -- -- allows creating "custom text objects"
  'kana/vim-textobj-user',

  {
    -- creates the 'i' indent text object
    -- preceded with 'i': refers to an indented paragraph
  ...
  -- shfmt - format on save
  {
    'z0mbix/vim-shfmt',
    ft = "sh",
    init = function()
      vim.g["shfmt_fmt_on_save"] = 1
      vim.g["shfmt_extra_args"] = '-i 2 -bn -sr -ci'
    end
  },
  ----------------------------------------------------------------------------
